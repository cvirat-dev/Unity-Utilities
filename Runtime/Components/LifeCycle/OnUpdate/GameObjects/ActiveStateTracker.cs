...
namespace UUP.Components.LifeCycle.OnUpdate.GameObjects
{
    /// <summary>
    /// Tracks the active state of a GameObject at <see cref="Update"/> and sets a BoolVariableSO to TRUE if active, FALSE if not.
    /// </summary>
    /// <remarks>
    ...
    public class ActiveStateTracker : MonoBehaviour
    {
        ...
        [SerializeField, Header("Tracker Variable"),
            Tooltip("If the GO is active on Update, will be set to TRUE. Else, FALSE")]
